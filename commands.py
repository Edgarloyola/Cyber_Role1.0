...
from cyber_role import db, user_manager, init_app
from cyber_role.models import Role, User
...
def init(lang):
    ...
    extract_cmd = (
        ...
        '-F babel.cfg '
        '-k "lazy_gettext _l" '
        '-o cyber_role/translations/messages.pot .'
    )

    init_cmd = (
        'pybabel init '
        '-i cyber_role/translations/messages.pot '
        '-d cyber_role/translations '
        '-l {}'
    )
